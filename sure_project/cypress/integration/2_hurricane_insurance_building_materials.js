...
describe('Hurricane Insurance Building Materials page', () => {
    ...
    //Next button dooesn't have a disabled UI or UX state. SURE-28 JIRA TICKET.
        ...
        cy.get(':nth-child(1) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('not.be.checked') //Confirming Straw radio is not checked
        cy.get(':nth-child(2) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('not.be.checked') //Confirming Sticks radio is not checked
        cy.get(':nth-child(3) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('not.be.checked') //Confirming Bricks radio is not checked
    ...
    it('Customer successfully selects and submits straw building material options and advances to the Water Proximity page', () => {
        ...
        cy.get(':nth-child(1) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('be.checked') //Confirming Straw radio is checked
        cy.contains('Next').click()
    ...
    it('Customer successfully selects and submits sticks building material options and advances to the Water Proximity page', () => {
        ...
        cy.get(':nth-child(2) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('be.checked') //Confirming Sticks radio is checked
        cy.contains('Next').click()
        cy.contains('Is your home located within 1 mile of a body of water?') //validating user advances to next step/page
    })
    ...
    it('Customer successfully selects and submits bricks building material options and advances to the Water Proximity page', () => {
        ...
        cy.get(':nth-child(3) > .MuiButtonBase-root > .MuiIconButton-label > .jss10').should('be.checked') //Confirming Bricks radio is checked
        cy.contains('Next').click()
        cy.contains('Is your home located within 1 mile of a body of water?') //validating user advances to next step/page
    })
})